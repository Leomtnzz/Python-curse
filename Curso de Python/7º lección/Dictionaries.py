...
# ejercicio papá
# ordenar por la última vocal del nombre
# papa1 = ('Nora', 'Leo', 'Luis', 'María', 'Ollie')
# vocales = ('a', 'e', 'i', 'o', 'u')
# print(sorted(papa1, ))

# print(sorted(papa1, reverse=False))
...
# add elementa from one set to another
morenums = {5, 6, 7}
nums.update(morenums)
#print(nums)

# se puede usar el update() con tuplas, dict y listas también


# merge two sets to a create a new one
one = {1, 2, 3}
two = {5, 6, 7}
